 ...
 * @see Läser & skriver till config fil som används i projektet, extrahera
 * info om ingående filer i warcfil.
...
public class ReadWriteXml {
    ...
    public String readConfigfile(String pathconfigfile, String tag){
        ...
        try{
            ...
            System.out.println("error:read_writeXML:ReadConfigfile... " +e.getMessage());
            return "fel";
        }catch(Throwable t){
            System.out.println("error:read_writeXML:ReadConfigfile... " +t.getMessage());
            return "fel";
        }
    }//end readconfigfile
